...
enum ChatRealtimeConnectionStatusSelfTests {
    static func run() {
        ...
        assert(ChatRealtimeConnectionStatus.offline.localizationKey == "chat_realtime_reconnecting")
        ...
        assert(ChatRealtimeConnectionStatus.offline.accessibilityBucket == "reconnecting")
