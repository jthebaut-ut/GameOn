...
struct ContentView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            ...
            FanTeamInvitationNotificationDeepLinkBridge.shared.bind(chatViewModel: chatViewModel)
            FanTeamDeletedNotificationDeepLinkBridge.shared.bind(chatViewModel: chatViewModel)
            FanTeamMemberLeftNotificationDeepLinkBridge.shared.bind(chatViewModel: chatViewModel)
            FanTeamMemberChangeNotificationDeepLinkBridge.shared.bind(chatViewModel: chatViewModel)
            ...
            FanGeoSecuritySessionNotificationDeepLinkBridge.shared.bind(viewModel: viewModel)
            MapViewModel.bindActionCenterNotificationIngestHost(viewModel)
            ...
            FanGeoSportMarkSelfTests.runAll()
            FanGeoPickupEmblemSelfTests.runAll()
            AgeAccessGateSelfTests.runAll()
            FanTeamsSelfTests.runAll()
            FanXPSelfTests.runAll()
            FanTeamPermissionsSelfTests.runAll()
            FanTeamDetailHeaderSelfTests.runAll()
            FanTeamEventTypeCatalogSelfTests.runAll()
            FanTeamEventScoringSelfTests.runAll()
            TeamEventVisibilitySelfTests.runAll()
            FanTeamHomeFilteringSelfTests.runAll()
            ManagedPlayerTeamAccessSelfTests.runAll()
            FanTeamPlayerInfoSelectionSelfTests.runAll()
            FanTeamEventLineupSelfTests.runAll()
            TeamEventPlayerDetailSelfTests.runAll()
            FanTeamSafetySelfTests.runAll()
            FloatingTabBarLayoutSelfTests.runAll()
            MainTabTeamsNavigationSelfTests.runAll()
            DiscoverPickupGameClusterSelectionSelfTests.runAll()
            FanProfileAvatarRefreshSelfTests.runAll()
            ChatRealtimeConnectionStatusSelfTests.run()
            DirectChatRealtimeLifecycleSelfTests.runAll()
            GroupChatRealtimeLifecycleSelfTests.runAll()
            ChatLocationShareSelfTests.runAll()
            ChatReplySelfTests.runAll()
            PickupGamePollSelfTests.runAll()
            FanTeamPollSelfTests.runAll()
            FanTeamLocationSelfTests.runAll()
            FanTeamOverviewAnnouncementSelfTests.runAll()
            PickupArrivalTimeSelfTests.runAll()
            PickupEventTypeCatalogSelfTests.runAll()
            ...
            FanTeamInvitationPushSelfTests.runAll()
            FanTeamDeletedPushSelfTests.runAll()
            FanTeamMemberLeftPushSelfTests.runAll()
            FanTeamPushMuteSelfTests.runAll()
            FriendGroupsSelfTests.runAll()
            FanManagedPlayerSelfTests.runAll()
            FanTeamColorThemeSelfTests.runAll()
            FanGeoJoinRequestEventIdentitySelfTests.runAll()
            GoingActionCenterSelfTests.runAll()
            ProfileMyTeamsSelfTests.runAll()
            ProfileHeroIdentityCardsSelfTests.runAll()
            ProfileIdentityScrollIsolationSelfTests.runAll()
            ProfileFirstOpenSelfTests.runAll()
            CalendarPlayPickupCardSelfTests.runAll()
            GoingPlaySelfTests.runAll()
            GoingWatchSelfTests.runAll()
            ChatInboxTypeFilterSelfTests.runAll()
            ChatFansLiveNowSelfTests.runAll()
            PublicProfileMessageNavigationSelfTests.runAll()
            TeamEventChatConsolidationSelfTests.run()
            ChatMyTeamsAdPlacementSelfTests.runAll()
            ChatInboxFanTeamAvatarSelfTests.runAll()
            ...
            PickupGameAppleCalendarEligibilitySelfTests.runAll()
            PickupGameRosterSelfTests.runAll()
            PickupGameDurationPresentationSelfTests.runAll()
            ...
            SportSubtypeCatalogSelfTests.runAll()
            _ = viewModel.runPickupMonthDotSelectionStabilityBoundaryTest()
            }
            SportsIdentityArtworkSelfTests.runAll()
            FavoriteTeamsOrderingSelfTests.runAll()
            FollowingPresentationSelfTests.runAll()
            FanGeoInboxLeadingArtworkSelfTests.runAll()
            FanGeoInboxPresentationSelfTests.runAll()
            FanGeoInboxPerformanceSelfTests.runAll()
            ProfileSportsArtworkSelfTests.runAll()
            SportsProviderArtworkSelfTests.runAll()
            SportsProviderAthleteCatalogSelfTests.runAll()
            GoingWatchSelfTests.runAll()
            GoingProGamesSelfTests.runAll()
            LiveFeaturedMatchupPresentationSelfTests.runAll()
            SignedOutLandingSelfTests.runAll()
            FanGeoFreshLaunchSelfTests.runAll()
            FanGeoLocalizationRegressionSelfTests.runAll()
            PickupBulkImportParserSelfTests.runAll()
            PickupImportEntryFeeSelfTests.runAll()
            FanTeamDiscoverabilitySelfTests.runAll()
            FanTeamArtworkPropagationSelfTests.runAll()
            Task {
                await FanTeamArtworkPropagationSelfTests.runCacheInvalidationSuite()
            }
            FanGeoActionCenterSelfTests.runAll()
            FanGeoNotificationInboxSelfTests.runAll()
            FanGeoSecuritySessionReplacementSelfTests.runAll()
            Task {
                await FanGeoPushArtworkSelfTests.runAll()
                await ProfileMyTeamsSelfTests.runCoalescerSuite()
            }
            FavoriteFollowingCountryBrowseSelfTests.runAll()
            FavoriteFollowingCountryViewConstructionSelfTests.runAll()
            #endif
        }
        ...
        .onChange(of: shouldShowSplash) { _, isShowingSplash in
            ...
            chatViewModel.deliverPendingFanTeamInvitationNotificationDeepLinkIfReady(reason: "splashDismissed")
        ...
        .onChange(of: bootstrapCoordinator.isBootstrapping) { _, isBootstrapping in
            ...
            chatViewModel.deliverPendingFanTeamInvitationNotificationDeepLinkIfReady(reason: "bootstrapComplete")
