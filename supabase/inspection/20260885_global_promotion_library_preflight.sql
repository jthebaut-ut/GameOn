-- =============================================================================
-- READ-ONLY preflight for 20260885 (formerly drafted as 20260884)
-- Global promotion library metadata + featured_promotion_runs
-- =============================================================================
-- Safe to run in Supabase SQL Editor. No writes. No DDL.
-- Run AFTER 20260883 has been applied. Do NOT apply 20260885 until this passes.
-- =============================================================================
...
-- 6. Which 20260885 columns already exist? (detect partial apply)
SELECT column_name
FROM information_schema.columns
WHERE table_schema = 'public'
  AND table_name = 'featured_events'
